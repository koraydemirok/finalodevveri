...
namespace DemirokPansiyonV._1
{
    public partial class FrmYeniMusteri : Form
    {
        ...
        {
            MessageBox.Show("Kırmızı renkli olanlar odanın dolu olduğu anlamına gelir.");
        }

        private void BtnBosOda_Click(object sender, EventArgs e)
        {
            MessageBox.Show("Yeşil renkli olanlar odanın boş olduğu anlamına gelir.");
        }

        private void DtpCikisTarihi_ValueChanged(object sender, EventArgs e)
        {
            int ucret;
            DateTime GirisT = Convert.ToDateTime(DtpGirisTarihi.Text);
            DateTime CikisT = Convert.ToDateTime(DtpCikisTarihi.Text);

            TimeSpan Sonuc = CikisT - GirisT;
